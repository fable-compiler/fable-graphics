...
exports.renderTexture = new PIXI.RenderTexture(renderer, renderer.width, renderer.height);
exports.renderTexture2 = new PIXI.RenderTexture(renderer, renderer.width, renderer.height);
var outputSprite = new PIXI.Sprite(exports.renderTexture);
...
var fruits = ["./public/assets/spinObj_01.png", "./public/assets/spinObj_02.png", "./public/assets/spinObj_03.png", "./public/assets/spinObj_04.png", "./public/assets/spinObj_05.png", "./public/assets/spinObj_06.png", "./public/assets/spinObj_07.png", "./public/assets/spinObj_08.png"];
var items = [];
...
var animate = function () {
  ...
  var animate_1 = function animate_1(dt) {
    ...
    for (var _i = 0; _i <= il; _i++) {
      var _item = items[_i];
      _item.rotation = _item.rotation + 0.1;
    }

    count = count + 0.01;
    var temp = exports.renderTexture;
    exports.renderTexture = exports.renderTexture2;
    exports.renderTexture2 = temp;
    outputSprite.texture = exports.renderTexture;
    stuffContainer.rotation = stuffContainer.rotation - 0.01;
    outputSprite.scale.set(1 + Math.sin(count) * 0.2);
    exports.renderTexture2.render(stage, null, false);
...
exports.stage = stage;
exports.outputSprite = outputSprite;
exports.stuffContainer = stuffContainer;
exports.fruits = fruits;
exports.items = items;
exports.animate = animate;

}((this.render_texture = this.render_texture || {}),PIXI));
