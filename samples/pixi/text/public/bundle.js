...
function create$6(pattern, options) {
    var flags = "g";
    flags += options & 1 ? "i" : "";
    flags += options & 2 ? "m" : "";
...
function matches(str, pattern) {
    ...
    var reg = str instanceof RegExp ? (reg = str, str = pattern, reg.lastIndex = options, reg) : reg = create$6(pattern, options);
...
function create$7(year, month, day) /* Local */{
...
var background = PIXI.Sprite.fromImage("./public/assets/textDemoBG.jpg");
...
var textSample = new PIXI.Text("Pixi.js can have\n multiline text!", style);
...
var spinningText = new PIXI.Text("I'm fun!", funStyle);
...
var countingText = new PIXI.Text("COUNT 4EVAR: 0", countingStyle);
...
var animate = function () {
  ...
  var animate_1 = function animate_1(dt) {
    ...
    count = count + 0.5;
    countingText.text = fsFormat("COUNT 4EVAR: %.0f")(function (x) {
      return x;
    })(Math.floor(count));
...
exports.style = style;
exports.textSample = textSample;
exports.funStyle = funStyle;
exports.spinningText = spinningText;
exports.countingStyle = countingStyle;
exports.countingText = countingText;
exports.animate = animate;

}((this.text = this.text || {}),PIXI));
